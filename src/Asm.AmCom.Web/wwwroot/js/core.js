...
/******/ 	return __webpack_require__(__webpack_require__.s = "./scripts/standard/Core.ts");
/******/ })
/************************************************************************/
/******/ ({
...
function switchTheme(e) {
  ...
  var oldTheme = body.classList.contains("dark") ? "Dark" : "Light";
  document.cookie = "theme=".concat(theme, ";path=/;max-age=3156000");
  e.target.innerText = "".concat(oldTheme, " Theme");

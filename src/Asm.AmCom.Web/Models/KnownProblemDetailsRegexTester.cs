...
public static partial class KnownProblemDetails
{
    ...
    {
        public static readonly ProblemDetails NullRequest = new()
        {
        ...
        public static readonly ProblemDetails EmptyRegex = new()
        {
        ...
        public static readonly ProblemDetails InvalidRegex = new()
        {
